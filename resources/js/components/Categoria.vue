                            ...
                            <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                <td>
                                    ...
                                    <template v-if="categoria.condicion">
                                        <button class="btn btn-danger btn-sm" type="button" @click="desactivarCategoria(categoria.id)">
                                            <i class="icon-trash"></i>
                                        </button>
                                    </template>
                                    <template v-else>
                                        <button class="btn btn-info btn-sm" type="button" @click="activarCategoria(categoria.id)">
                                ...
                                <td>
                                    ...
                                    <div v-else>
                                        <span class="badge badge-danger">Desacivado</span>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
